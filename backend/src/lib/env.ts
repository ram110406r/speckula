...
const envSchema = z.object({
  ...
  DIRECT_DATABASE_URL: z.preprocess(
    ...
    z.string().url('DIRECT_DATABASE_URL must be a valid postgresql:// URL').optional()
  ),
  ...
  FRONTEND_URL: z.preprocess(
    emptyStringToUndefined,
    z.string().url('FRONTEND_URL must be a valid URL, e.g. https://app.Speckula.io').optional()
  ),
  ...
  SLACK_TOKEN_ENCRYPTION_KEY: z.preprocess(
    emptyStringToUndefined,
  ...
  RESEND_API_KEY: z.preprocess(
    emptyStringToUndefined,
    z.string().startsWith('re_', 'RESEND_API_KEY must start with "re_". Get one at resend.com').optional()
  ),
  ...
  OPENAI_API_KEY: z.preprocess(
    emptyStringToUndefined,
    z.string().startsWith('sk-', 'OPENAI_API_KEY must start with "sk-"').optional()
  ),
