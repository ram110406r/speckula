      ...
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-2xl border border-border/60 bg-card p-8 shadow-lg">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 h-10 rounded-xl border border-border/60 bg-card text-sm font-medium text-foreground hover:bg-muted transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
          >
            {isSigningIn ? (
