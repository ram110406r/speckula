...
export default function GlobalError({
  ...
  return (
    <html lang="en">
      <body style={{ margin: 0, fontFamily: "sans-serif", background: "#f7f4ec" }}>
        <div style={{ display: "flex", minHeight: "100vh", alignItems: "center", justifyContent: "center", padding: "0 24px" }}>
          <div style={{ maxWidth: 420, textAlign: "center" }}>
            ...
            <div style={{ display: "flex", justifyContent: "center", gap: 8 }}>
              <button
                onClick={reset}
                style={{ padding: "8px 20px", borderRadius: 6, border: "none", background: "#c04a2b", color: "#fff", cursor: "pointer", fontSize: 14, fontWeight: 500 }}
              >
                Try again
              </button>
              <button
