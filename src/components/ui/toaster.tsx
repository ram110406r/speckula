    ...
    <div className="fixed bottom-4 right-4 z-[9999] flex flex-col gap-2 pointer-events-none">
      {toasts.map((t) => {
        ...
        return (
          <div
            key={t.id}
            className={`pointer-events-auto flex items-start gap-3 w-80 rounded-lg border px-4 py-3 shadow-lg backdrop-blur-sm animate-in slide-in-from-right-4 fade-in duration-200 ${cls} bg-card`}
          >
